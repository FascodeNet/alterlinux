...
make_efi() {
    ...
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/PreLoader.efi ${work_dir}/iso/EFI/boot/bootx64.efi
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/HashTool.efi ${work_dir}/iso/EFI/boot/
...
make_efiboot() {
    ...
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/PreLoader.efi ${work_dir}/efiboot/EFI/boot/bootx64.efi
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/HashTool.efi ${work_dir}/efiboot/EFI/boot/
