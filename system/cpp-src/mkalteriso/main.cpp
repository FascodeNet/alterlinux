...
void AppMain::run()
{
    ...
    parser.addOptions({option_Architecture,option_PACKAGE,option_command,option_file_pacman,option_work_dir
                      ,option_out_dir,option_sfs_mode,option_sfs_comp,option_sfs_special_option,option_iso_label,option_iso_publisher});
    ...
    commandkun_parser.addPositionalArgument("init","initialize");
    ...
    std::cout << build_setting_obj.get_iso_label().toStdString() << std::endl;
    app->exit();
}
